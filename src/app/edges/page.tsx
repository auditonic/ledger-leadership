...
export const metadata: Metadata = {
  title: 'The Five Edges — Ledger Leadership',
  description: 'Each edge cuts ambiguity in a specific direction. Reality, Obligation, Continuity, Margin, Reconciliation.',
};
